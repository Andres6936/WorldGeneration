        ...
        <>
            ...
            <div className="abs top:0 z:1 h:full w:2px ml:-1px bg:black left:15rem">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                     className="abs z:2 color:#333 w:32px h:32px top:50% left:15rem translate(50%,50%) p:6px b:2px|solid|currentColor r:50% bg:rgba(255,255,255,1) max-w:fit"
                     viewBox="0 0 16 16">
            ...
            <input
                ...
                type="range" min="0" step="0.5" max="100" value="50"/>
        </>
    )
}